...
// But when put make_simple_callback outside of the struct, we can make callback in a magnificent way:
// make_simple_callback(pObj, &Obj::Func);
// or make_simple_callback(&Obj::Func);
...
{
	simple_callback<t_ret> cb;
	cb.bind<t_object, t_func>(pObj);
	return cb;
}

template <class _ObjectType, class t_ret, class _P0>
simple_callback<t_ret, _P0> make_simple_callback(_ObjectType* pObj,
...
simple_callback<t_ret, _P0, _P1> make_simple_callback(_ObjectType* pObj,
...
simple_callback<t_ret, _P0, _P1, _P2> make_simple_callback(_ObjectType* pObj,
...
simple_callback<t_ret, _P0, _P1, _P2, _P3> make_simple_callback(_ObjectType* pObj,
...
simple_callback<t_ret, _P0, _P1, _P2, _P3, _P4> make_simple_callback(_ObjectType* pObj,
...
simple_callback<t_ret, _P0, _P1, _P2, _P3, _P4, _P5> make_simple_callback(_ObjectType* pObj,
