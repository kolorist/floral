...
template <class t_type, size t_capacity>
class inplace_spsc_queue_lock_based_t
{
	typedef t_type								value_t;
	typedef value_t&							reference_t;
	typedef size								index_t;
...
public:
	inplace_spsc_queue_lock_based_t()
		: m_read_idx(0)
		, m_write_idx(0)
		, m_capacity(t_capacity)
	{
